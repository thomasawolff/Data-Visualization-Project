...
def graphWriterIRI():
    ...
    try:
        ...
        base2 = ax2.plot(start[0][0:50],listNew()[2][0:50])
    ...
    try:
        ...
        base21 = ax2.plot(start[0],baselineCSV()[1][0:50])
...
def graphWriterRut():
    ...
    try:
        ...
        base2 = ax4.plot(start[0][0:50],listNew()[4][0:50])
        plt.setp(base2, color='y', linewidth=8.0, alpha=0.7) # adjusting the plot lines properties
    except KeyError: pass
    except TypeError: pass
    except ValueError: pass
    ...
    try:
        ...
        base41 = ax4.plot(start[0][0:50],baselineCSV()[3][0:50])
